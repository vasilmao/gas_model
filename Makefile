...
$(BinDir)/a.out: $(IntDir)/main.o $(IntDir)/App.o $(IntDir)/Vector.o $(IntDir)/CoordSystem.o $(IntDir)/Renderer.o $(IntDir)/Circle.o
	$(CXX) -o $(BinDir)/a.out $(IntDir)/main.o $(IntDir)/App.o $(IntDir)/Vector.o $(IntDir)/CoordSystem.o $(IntDir)/Renderer.o $(IntDir)/Circle.o $(LXXFLAGS)
